...
{   
    ...
    {
        public CaptureImageEncoder.ImageFormat _imageFormat = CaptureImageEncoder.ImageFormat.Tga;
        ...
        void Start()
        {
            ...
            if (_camera == null)
                enabled = false;
            _baseDirectory = DXManager.Instance.GetDirectoryFor(DataCapturePaths.ScreenCapture);
        }
