...
namespace UnityEngine.SimViz
{
    ...
    {
        static readonly Guid s_DatasetGuid = Guid.NewGuid();
        ...
        static SimulationState CreateSimulationData()
        {
            ...
            return new SimulationState(Manager.Instance.GetDirectoryFor($"Dataset{s_DatasetGuid}"));
        }
    ...
    public struct AsyncAnnotation
    {
        ...
        public bool IsValid => !IsNil && m_SimulationState.IsRunning;
        /// <summary>
        /// True if neither <see cref="ReportValues"/> nor <see cref="ReportFile"/> have been called.
        /// </summary>
