...
namespace Unity.Entities.Tests
{
    ...
    public class EntityMatch
    {
        ...
        public static EntityMatch Exact(params object[] matchData)
            => Match(MatchType.Exact, Array.Empty<Type>(), matchData);
        public static EntityMatch Exact<T0>(params object[] matchData)
            => Match(MatchType.Exact, new[] { typeof(T0) }, matchData);
        public static EntityMatch Exact<T0, T1>(params object[] matchData)
            => Match(MatchType.Exact, new[] { typeof(T0), typeof(T1) }, matchData);
        public static EntityMatch Exact<T0, T1, T2>(params object[] matchData)
            => Match(MatchType.Exact, new[] { typeof(T0), typeof(T1), typeof(T2) }, matchData);
        public static EntityMatch Exact<T0, T1, T2, T3>(params object[] matchData)
            => Match(MatchType.Exact, new[] { typeof(T0), typeof(T1), typeof(T2), typeof(T3) }, matchData);
        public static EntityMatch Exact<T0, T1, T2, T3, T4>(params object[] matchData)
            => Match(MatchType.Exact, new[] { typeof(T0), typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, matchData);
        public static EntityMatch Exact<T0, T1, T2, T3, T4, T5>(params object[] matchData)
            => Match(MatchType.Exact, new[] { typeof(T0), typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, matchData);
        ...
        /// </summary>
        public static EntityMatch Partial(params object[] matchData)
            => Match(MatchType.Partial, Array.Empty<Type>(), matchData);
        public static EntityMatch Partial<T0>(params object[] matchData)
            => Match(MatchType.Partial, new[] { typeof(T0) }, matchData);
        public static EntityMatch Partial<T0, T1>(params object[] matchData)
            => Match(MatchType.Partial, new[] { typeof(T0), typeof(T1) }, matchData);
        public static EntityMatch Partial<T0, T1, T2>(params object[] matchData)
            => Match(MatchType.Partial, new[] { typeof(T0), typeof(T1), typeof(T2) }, matchData);
        public static EntityMatch Partial<T0, T1, T2, T3>(params object[] matchData)
            => Match(MatchType.Partial, new[] { typeof(T0), typeof(T1), typeof(T2), typeof(T3) }, matchData);
        public static EntityMatch Partial<T0, T1, T2, T3, T4>(params object[] matchData)
            => Match(MatchType.Partial, new[] { typeof(T0), typeof(T1), typeof(T2), typeof(T3), typeof(T4) }, matchData);
        public static EntityMatch Partial<T0, T1, T2, T3, T4, T5>(params object[] matchData)
            => Match(MatchType.Partial, new[] { typeof(T0), typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, matchData);
        public static EntityMatch Partial<T0, T1, T2, T3, T4, T5, T6>(params object[] matchData)
            => Match(MatchType.Partial, new[] { typeof(T0), typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6) }, matchData);
        ...
        static EntityMatch Match(MatchType matchType, Type[] componentTypes, object[] matchData)
        {
            ...
            bool Match(DebugEntity debugEntity)
            {
                ...
                return !debugComponents.Any() || matchType == MatchType.Partial;
            }
