...
#pragma warning disable 618
        ...
        internal struct JobStruct_ProcessInfer_C<T> where T : struct
        {
            ...
            where T0 : struct, IComponentData
        {
            ...
            {
                ChunkIterationUtility.UnpackPrefilterData(jobData.PrefilterData, out var chunks, out var entityIndices, out var chunkCount);
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_C<T, T0> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
					...
					ChunkDataUtility.GetIndexInTypeArray(chunk.m_Chunk->Archetype, jobData.Iterator.TypeIndex0, ref typeLookupCache0);
						var ptr0 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly0 == 0, typeLookupCache0, jobData.Iterator.GlobalSystemVersion);
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EC<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            where T0 : struct, IComponentData
        {
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_EC<T, T0> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
                    ...
                    JobsUtility.PatchBufferMinMaxRanges(bufferRangePatchData, UnsafeUtility.AddressOf(ref jobData), beginIndex, beginIndex + count);
#endif
					var ptrE = (Entity*)ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, false, 0, jobData.Iterator.GlobalSystemVersion);
					ChunkDataUtility.GetIndexInTypeArray(chunk.m_Chunk->Archetype, jobData.Iterator.TypeIndex0, ref typeLookupCache0);
						var ptr0 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly0 == 0, typeLookupCache0, jobData.Iterator.GlobalSystemVersion);
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_B<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_B<T, T0> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
                    ...
                    fixed (AtomicSafetyHandle* safety = &jobData.Iterator.m_Safety0)
                    {
						...
						var buffer0 = ChunkIterationUtility.GetChunkBufferAccessor<T0>(chunk.m_Chunk, jobData.Iterator.IsReadOnly0 == 0, typeLookupCache0, jobData.Iterator.GlobalSystemVersion, safety[safety0], safety[safety0 + 1]);
#else
						var buffer0 = ChunkIterationUtility.GetChunkBufferAccessor<T0>(chunk.m_Chunk, jobData.Iterator.IsReadOnly0 == 0, typeLookupCache0, jobData.Iterator.GlobalSystemVersion);
#endif
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EB<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_CC<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_CC<T, T0, T1> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
					...
					ChunkDataUtility.GetIndexInTypeArray(chunk.m_Chunk->Archetype, jobData.Iterator.TypeIndex1, ref typeLookupCache1);
						var ptr0 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly0 == 0, typeLookupCache0, jobData.Iterator.GlobalSystemVersion);
						var ptr1 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly1 == 0, typeLookupCache1, jobData.Iterator.GlobalSystemVersion);
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_ECC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BB<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_BB<T, T0, T1> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
                    ...
                    fixed (AtomicSafetyHandle* safety = &jobData.Iterator.m_Safety0)
                    {
						...
						var buffer1 = ChunkIterationUtility.GetChunkBufferAccessor<T1>(chunk.m_Chunk, jobData.Iterator.IsReadOnly1 == 0, typeLookupCache1, jobData.Iterator.GlobalSystemVersion, safety[safety1], safety[safety1 + 1]);
#else
						var buffer0 = ChunkIterationUtility.GetChunkBufferAccessor<T0>(chunk.m_Chunk, jobData.Iterator.IsReadOnly0 == 0, typeLookupCache0, jobData.Iterator.GlobalSystemVersion);
						var buffer1 = ChunkIterationUtility.GetChunkBufferAccessor<T1>(chunk.m_Chunk, jobData.Iterator.IsReadOnly1 == 0, typeLookupCache1, jobData.Iterator.GlobalSystemVersion);
#endif
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBB<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_CCC<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_CCC<T, T0, T1, T2> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
					...
					ChunkDataUtility.GetIndexInTypeArray(chunk.m_Chunk->Archetype, jobData.Iterator.TypeIndex2, ref typeLookupCache2);
						var ptr0 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly0 == 0, typeLookupCache0, jobData.Iterator.GlobalSystemVersion);
						var ptr1 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly1 == 0, typeLookupCache1, jobData.Iterator.GlobalSystemVersion);
						var ptr2 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly2 == 0, typeLookupCache2, jobData.Iterator.GlobalSystemVersion);
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_ECCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBB<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_BBB<T, T0, T1, T2> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
                    ...
                    fixed (AtomicSafetyHandle* safety = &jobData.Iterator.m_Safety0)
                    {
						...
						var buffer2 = ChunkIterationUtility.GetChunkBufferAccessor<T2>(chunk.m_Chunk, jobData.Iterator.IsReadOnly2 == 0, typeLookupCache2, jobData.Iterator.GlobalSystemVersion, safety[safety2], safety[safety2 + 1]);
#else
						var buffer0 = ChunkIterationUtility.GetChunkBufferAccessor<T0>(chunk.m_Chunk, jobData.Iterator.IsReadOnly0 == 0, typeLookupCache0, jobData.Iterator.GlobalSystemVersion);
						var buffer1 = ChunkIterationUtility.GetChunkBufferAccessor<T1>(chunk.m_Chunk, jobData.Iterator.IsReadOnly1 == 0, typeLookupCache1, jobData.Iterator.GlobalSystemVersion);
						var buffer2 = ChunkIterationUtility.GetChunkBufferAccessor<T2>(chunk.m_Chunk, jobData.Iterator.IsReadOnly2 == 0, typeLookupCache2, jobData.Iterator.GlobalSystemVersion);
#endif
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBB<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_CCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_CCCC<T, T0, T1, T2, T3> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
					...
					ChunkDataUtility.GetIndexInTypeArray(chunk.m_Chunk->Archetype, jobData.Iterator.TypeIndex3, ref typeLookupCache3);
						...
						var ptr1 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly1 == 0, typeLookupCache1, jobData.Iterator.GlobalSystemVersion);
						var ptr2 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly2 == 0, typeLookupCache2, jobData.Iterator.GlobalSystemVersion);
						var ptr3 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly3 == 0, typeLookupCache3, jobData.Iterator.GlobalSystemVersion);
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_ECCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBBC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBBC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBBB<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_BBBB<T, T0, T1, T2, T3> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
                    ...
                    fixed (AtomicSafetyHandle* safety = &jobData.Iterator.m_Safety0)
                    {
						...
						var buffer3 = ChunkIterationUtility.GetChunkBufferAccessor<T3>(chunk.m_Chunk, jobData.Iterator.IsReadOnly3 == 0, typeLookupCache3, jobData.Iterator.GlobalSystemVersion, safety[safety3], safety[safety3 + 1]);
#else
						var buffer0 = ChunkIterationUtility.GetChunkBufferAccessor<T0>(chunk.m_Chunk, jobData.Iterator.IsReadOnly0 == 0, typeLookupCache0, jobData.Iterator.GlobalSystemVersion);
						var buffer1 = ChunkIterationUtility.GetChunkBufferAccessor<T1>(chunk.m_Chunk, jobData.Iterator.IsReadOnly1 == 0, typeLookupCache1, jobData.Iterator.GlobalSystemVersion);
						var buffer2 = ChunkIterationUtility.GetChunkBufferAccessor<T2>(chunk.m_Chunk, jobData.Iterator.IsReadOnly2 == 0, typeLookupCache2, jobData.Iterator.GlobalSystemVersion);
						var buffer3 = ChunkIterationUtility.GetChunkBufferAccessor<T3>(chunk.m_Chunk, jobData.Iterator.IsReadOnly3 == 0, typeLookupCache3, jobData.Iterator.GlobalSystemVersion);
#endif
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBBB<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_CCCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_CCCCC<T, T0, T1, T2, T3, T4> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
					...
					ChunkDataUtility.GetIndexInTypeArray(chunk.m_Chunk->Archetype, jobData.Iterator.TypeIndex4, ref typeLookupCache4);
						...
						var ptr2 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly2 == 0, typeLookupCache2, jobData.Iterator.GlobalSystemVersion);
						var ptr3 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly3 == 0, typeLookupCache3, jobData.Iterator.GlobalSystemVersion);
						var ptr4 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly4 == 0, typeLookupCache4, jobData.Iterator.GlobalSystemVersion);
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_ECCCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BCCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBCCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBBCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBBCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBBBC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBBBC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBBBB<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_BBBBB<T, T0, T1, T2, T3, T4> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
                    ...
                    fixed (AtomicSafetyHandle* safety = &jobData.Iterator.m_Safety0)
                    {
						...
						var buffer4 = ChunkIterationUtility.GetChunkBufferAccessor<T4>(chunk.m_Chunk, jobData.Iterator.IsReadOnly4 == 0, typeLookupCache4, jobData.Iterator.GlobalSystemVersion, safety[safety4], safety[safety4 + 1]);
#else
						var buffer0 = ChunkIterationUtility.GetChunkBufferAccessor<T0>(chunk.m_Chunk, jobData.Iterator.IsReadOnly0 == 0, typeLookupCache0, jobData.Iterator.GlobalSystemVersion);
						var buffer1 = ChunkIterationUtility.GetChunkBufferAccessor<T1>(chunk.m_Chunk, jobData.Iterator.IsReadOnly1 == 0, typeLookupCache1, jobData.Iterator.GlobalSystemVersion);
						var buffer2 = ChunkIterationUtility.GetChunkBufferAccessor<T2>(chunk.m_Chunk, jobData.Iterator.IsReadOnly2 == 0, typeLookupCache2, jobData.Iterator.GlobalSystemVersion);
						var buffer3 = ChunkIterationUtility.GetChunkBufferAccessor<T3>(chunk.m_Chunk, jobData.Iterator.IsReadOnly3 == 0, typeLookupCache3, jobData.Iterator.GlobalSystemVersion);
						var buffer4 = ChunkIterationUtility.GetChunkBufferAccessor<T4>(chunk.m_Chunk, jobData.Iterator.IsReadOnly4 == 0, typeLookupCache4, jobData.Iterator.GlobalSystemVersion);
#endif
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBBBB<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_CCCCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_CCCCCC<T, T0, T1, T2, T3, T4, T5> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
					...
					ChunkDataUtility.GetIndexInTypeArray(chunk.m_Chunk->Archetype, jobData.Iterator.TypeIndex5, ref typeLookupCache5);
						...
						var ptr3 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly3 == 0, typeLookupCache3, jobData.Iterator.GlobalSystemVersion);
						var ptr4 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly4 == 0, typeLookupCache4, jobData.Iterator.GlobalSystemVersion);
						var ptr5 = ChunkIterationUtility.GetChunkComponentDataPtr(chunk.m_Chunk, jobData.Iterator.IsReadOnly5 == 0, typeLookupCache5, jobData.Iterator.GlobalSystemVersion);
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_ECCCCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BCCCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBCCCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBCCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBCCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBBCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBBCCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBBBCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBBBCC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBBBBC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBBBBC<T> where T : struct
        {
            public static JobForEachCache Cache;
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_BBBBBB<T> where T : struct
        {
            public static JobForEachCache Cache;
            ...
            static unsafe void ExecuteChunk(ref JobStruct_Process_BBBBBB<T, T0, T1, T2, T3, T4, T5> jobData, IntPtr bufferRangePatchData, int begin, int end, ArchetypeChunk* chunks, int* entityIndices)
            {
                ...
                for (var blockIndex = begin; blockIndex != end; ++blockIndex)
                {
                    ...
                    fixed (AtomicSafetyHandle* safety = &jobData.Iterator.m_Safety0)
                    {
						...
						var buffer5 = ChunkIterationUtility.GetChunkBufferAccessor<T5>(chunk.m_Chunk, jobData.Iterator.IsReadOnly5 == 0, typeLookupCache5, jobData.Iterator.GlobalSystemVersion, safety[safety5], safety[safety5 + 1]);
#else
						var buffer0 = ChunkIterationUtility.GetChunkBufferAccessor<T0>(chunk.m_Chunk, jobData.Iterator.IsReadOnly0 == 0, typeLookupCache0, jobData.Iterator.GlobalSystemVersion);
						var buffer1 = ChunkIterationUtility.GetChunkBufferAccessor<T1>(chunk.m_Chunk, jobData.Iterator.IsReadOnly1 == 0, typeLookupCache1, jobData.Iterator.GlobalSystemVersion);
						var buffer2 = ChunkIterationUtility.GetChunkBufferAccessor<T2>(chunk.m_Chunk, jobData.Iterator.IsReadOnly2 == 0, typeLookupCache2, jobData.Iterator.GlobalSystemVersion);
						var buffer3 = ChunkIterationUtility.GetChunkBufferAccessor<T3>(chunk.m_Chunk, jobData.Iterator.IsReadOnly3 == 0, typeLookupCache3, jobData.Iterator.GlobalSystemVersion);
						var buffer4 = ChunkIterationUtility.GetChunkBufferAccessor<T4>(chunk.m_Chunk, jobData.Iterator.IsReadOnly4 == 0, typeLookupCache4, jobData.Iterator.GlobalSystemVersion);
						var buffer5 = ChunkIterationUtility.GetChunkBufferAccessor<T5>(chunk.m_Chunk, jobData.Iterator.IsReadOnly5 == 0, typeLookupCache5, jobData.Iterator.GlobalSystemVersion);
#endif
        ...
        [StructLayout(LayoutKind.Sequential)]
        internal struct JobStruct_ProcessInfer_EBBBBBB<T> where T : struct
        {
            public static JobForEachCache Cache;
